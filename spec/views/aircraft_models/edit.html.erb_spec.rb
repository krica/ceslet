...
describe "/aircraft_models/edit.html.erb" do
  ...
  it "renders the edit aircraft_model form" do
    render

    response.should have_tag("form[action=#{aircraft_model_path(@aircraft_model)}][method=post]") do
